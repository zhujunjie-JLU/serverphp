...
if (!defined('PHPEXCEL_ROOT')) {//检查常量是否存在，如果还没用过就可以用
    define('PHPEXCEL_ROOT', dirname(__FILE__) . '/');//取文件所在的地址，并且放到常量PHPEXCEL_ROOT中
    require(PHPEXCEL_ROOT . 'PHPExcel/Autoloader.php');//执行这个文件
}
